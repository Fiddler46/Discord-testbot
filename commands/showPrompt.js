...
Once you are ready to respond, simply trigger me with \`!reply @channel_id ...\` where \`...\` represents your response. Also make sure to add in tags #f, #e, #b to denote features, enhancements & bugs worked upon respectively :smile:
    `);
  },
};
