...
Once you are ready to respond, simply trigger me with \`!reply ...\` where \`...\` represents your response. Also make sure to add in tags #f, #e, #b to denote features, enhancements & blockers worked upon respectively :smile:
    `);
  },
};
